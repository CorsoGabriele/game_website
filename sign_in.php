...
<html lang="en">
	...
	<body>
		...
		<h1 id="title" class="text-center font-weight-bold">Sign up</h1> 
			...
			<form action="interactions/sign_inscript.php" method="POST">
				...
				<div class="form-group col-10">
					...
					<small style="color: white">
						must contain at least 3 characters, including at least one non-alphanumeric character
					</small>
				</div>
				<button name="signin" id="signb" type="submit" class="btn btn-primary" method="POST" disabled>Sign up</button>
			</form>
		</div>
